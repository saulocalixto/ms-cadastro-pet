...
func valideProprietario(proprietario dto.ProprietarioDTO, validations []dto.ValidationDTO) []dto.ValidationDTO {
	if (dto.ProprietarioDTO{} == proprietario) {
...
func valideVeterinario(veterinario dto.VeterinarioDTO, validations []dto.ValidationDTO) []dto.ValidationDTO {
	if (dto.VeterinarioDTO{} != veterinario) {
